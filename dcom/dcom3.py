...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(1,samp_rate,8*samp_rate,2,11)
        ...
        self.analog_noise_source_x_0 = analog.noise_source_c(analog.GR_GAUSSIAN, 0.075, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_rrc_taps(firdes.root_raised_cosine(1,self.samp_rate,8*self.samp_rate,2,11))
