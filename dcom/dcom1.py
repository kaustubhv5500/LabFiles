...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_2 = qtgui.time_sink_f(
        	1024, #size
        	samp_rate, #samp_rate
        	"Received UDP Time Domain Waveform", #name
        	1 #number of inputs
        )
        ...
        self.qtgui_freq_sink_x_2 = qtgui.freq_sink_f(
        	...
        	0, #fc
        	samp_rate, #bw
        	"Received UDP Frequency Spectrum", #name
        	1 #number of inputs
        )
        ...
        self.blocks_udp_source_0 = blocks.udp_source(gr.sizeof_float*1, '127.0.0.1', 9008, 1472, True)
        self.blocks_udp_sink_0 = blocks.udp_sink(gr.sizeof_float*1, '127.0.0.1', 9008, 1472, True)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 1000, 1, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 3300, 1, -0.5)
        self.analog_noise_source_x_0 = analog.noise_source_f(analog.GR_UNIFORM, 0.2, 0)
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.blocks_throttle_2, 0))
        ...
        self.connect((self.blocks_throttle_2, 0), (self.blocks_udp_sink_0, 0))
        self.connect((self.blocks_udp_source_0, 0), (self.qtgui_freq_sink_x_2, 0))
        self.connect((self.blocks_udp_source_0, 0), (self.qtgui_time_sink_x_2, 0))
