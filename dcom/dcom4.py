...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._EbN0_range = Range(-20, 20, 1, 10, 200)
        self._EbN0_win = RangeWidget(self._EbN0_range, self.set_EbN0, 'Eb/N0', "counter_slider", float)
        ...
        self.analog_random_source_x_0 = blocks.vector_source_b(map(int, numpy.random.randint(0, const[const_type].arity(), 10000000)), False)
        self.analog_noise_source_x_0 = analog.noise_source_c(analog.GR_GAUSSIAN, 1.0/math.sqrt(2.0 *const[const_type].bits_per_symbol() * 10**(EbN0/10)), 0)
