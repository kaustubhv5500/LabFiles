...
\begin{figure}[htpb]
\centerline{
\begin{tikzpicture}[thick,scale=0.77, every node/.style={scale=0.77},text width=35ex, align=center,node distance=1.5cm,>=latex']
...
\begin{comment}
\begin{figure}[htpb]
\centerline{\includegraphics[scale=0.5]{block diagram-2.png}}
